...
public class WeaponSystem : MonoBehaviour
{
    ...
    private InputFeatureUsage<bool> gripButtonFeature = CommonUsages.gripButton;
	...
	void Update()
	{
        ...
        if (rightHand.TryGetFeatureValue(gripButtonFeature, out bool gripButtonValue))
        {
            isGripButtonPressed = gripButtonValue;
        }
        ...
        {
            // Example: Switch to the next weapon when grip button is pressed
            NextWeapon();
        }
    }
