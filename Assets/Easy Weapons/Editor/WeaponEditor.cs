...
public class WeaponEditor : Editor
{
	...
	public override void OnInspectorGUI()
	{
		...
		damageFX = EditorGUILayout.Foldout(damageFX, "DamageFX");
        if (damageFX)
        {
            weapon.ImpactFX=(Transform)EditorGUILayout.ObjectField("ImpactFX", weapon.ImpactFX, typeof(Transform), false);
        }
